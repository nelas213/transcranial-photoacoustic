...
parser.add_argument('--save_path', default=save_path, type=str, required=False)
parser.add_argument('--dataset_name', default="test", type=str)
parser.add_argument('--num_trees', default=3, type=int)
...
parser.add_argument('--num_centerline_points', default=1000, type=int)
...
main_branch_properties = {
    1: {"name": "RCA", "min_length": 0.120, "max_length": 0.140, "max_diameter": 0.002}, #units in [m] not [mm]
    2: {"name": "LAD", "min_length": 0.100, "max_length": 0.130, "max_diameter": 0.002},
    3: {"name": "LCx", "min_length": 0.080, "max_length": 0.100, "max_diameter": 0.0015},
}
